...
export const MusicCardComponent: FunctionComponent<IMusicCardComponent> = ({ music, isPlaylist }) => {
  ...
  return (
    <div className={`bg-transparent flex ${isPlaylist ? 'w-full' : 'w-[49.6%]'} mx-auto justify-between items-center hover:bg-root-card-light dark:hover:bg-root-card-dark transition rounded p-3 pl-0 group`}>
